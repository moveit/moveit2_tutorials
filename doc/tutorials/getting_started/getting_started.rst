...
If you are just getting started we would recommend you use the latest stable version of ROS (Humble) on Ubuntu 22.04 for the most seamless experience.
- `Rolling Ridley <https://docs.ros.org/en/rolling/Installation.html>`_ - Rolling Development Release
- `Irin Irwini <https://docs.ros.org/en/iron/Installation.html>`_ - Next Stable Release - May 2023
