...
//  auto initial{ std::make_unique<moveit::task_constructor::stages::FixedState>("start") };
//  initial->setState(scene);
//  task.add(std::move(initial));

//  {
//    auto connect{ std::make_unique<moveit::task_constructor::stages::Connect>(
//       "path length", moveit::task_constructor::stages::Connect::GroupPlannerVector{ { "panda_arm", sampling_planner } }) };
...
//  }
  ...
  auto stage_move_to_pick = std::make_unique<moveit::task_constructor::stages::Connect>(
      "move to pick", moveit::task_constructor::stages::Connect::GroupPlannerVector{ { arm_group_name, sampling_planner } });
