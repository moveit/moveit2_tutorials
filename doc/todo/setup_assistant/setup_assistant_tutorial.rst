...
can go through the :doc:`URDF/SRDF Overview </doc/todo/urdf_srdf/urdf_srdf_tutorial>`
page.
...
* We will first add Panda arm as a planning group
  ...
  * Choose *kdl_kinematics_plugin/KDLKinematicsPlugin* as the
    ...
    like a powerful custom IK solver, see* :doc:`Kinematics/IKFast </doc/todo/ikfast/ikfast_tutorial>`
...
For more details about those parameters please see perception pipeline :doc:`tutorial </doc/todo/perception_pipeline/perception_pipeline_tutorial>`
...
* A faster IK solver than the default KDL solver, but takes some
  ...
  :doc:`Kinematics/IKFast </doc/todo/ikfast/ikfast_tutorial>`

Additional Reading
---------------------

* See the :doc:`URDF and SRDF </doc/todo/urdf_srdf/urdf_srdf_tutorial>` page for more
