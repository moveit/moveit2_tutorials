...
For more information on how to plan with path constraints in general, take a look at `here </doc/todo/move_group_interface/move_group_interface_tutorial.html#planning-with-path-constraints>`_.
