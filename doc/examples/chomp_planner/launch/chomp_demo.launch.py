...
def generate_launch_description():
  ...
  # Command-line arguments
    ...
    moveit_config = (
        MoveItConfigsBuilder("moveit2_tutorials")
    ...
    chomp_planning_yaml = load_yaml(
        "moveit2_tutorials", "config/chomp_planning.yaml"
    )
    moveit_config["chomp"].update(chomp_planning_yaml)
    ...
    rviz_base = os.path.join(
        get_package_share_directory("moveit2_tutorials"), "config"
    )
