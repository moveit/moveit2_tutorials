...
3. Run the script.
  ...
  .. code-block:: bash
    ...
    start-docker.sh moveit2-galactic moveit/moveit2:galactic-source
  ...
  .. code-block:: bash
    ...
    start-docker.sh moveit2-galactic moveit/moveit2:galactic-source false
...
4. You should now be inside of your Docker container, in the workspace directory. You should now be able to start working with MoveIt!
  ...
  .. code-block:: bash
    ...
    start-docker.sh moveit2-galactic
