...
extlinks = {'codedir': ('https://github.com/' + html_context["github_user"] + '/moveit2_tutorials/blob/' + html_context["github_version"] + '/doc/%s', ''),
            ...
            'moveit_core': ('http://docs.ros.org/' + ros1_distro + '/api/moveit_core/html/cpp/classmoveit_1_1core_1_1%s.html', ''),
            'planning_scene': ('http://docs.ros.org/' + ros1_distro + '/api/moveit_core/html/cpp/classplanning__scene_1_1%s.html', ''),
            ...
            'collision_detection_struct': ('http://docs.ros.org/' + ros1_distro + '/api/moveit_core/html/cpp/structcollision__detection_1_1%s.html', ''),
            'collision_detection_class': ('http://docs.ros.org/' + ros1_distro + '/api/moveit_core/html/cpp/classcollision__detection_1_1%s.html', ''),
            'kinematic_constraints': ('http://docs.ros.org/' + ros1_distro + '/api/moveit_core/html/cpp/classkinematic__constraints_1_1%s.html', ''),
            'moveit_core_files': ('http://docs.ros.org/' + ros1_distro + '/api/moveit_core/html/cpp/%s.html', ''),
