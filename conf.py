...
# Directories to also copy
html_extra_path = ['doc/_assets/']
...
html_favicon = 'doc/_assets/images/favicon.ico'
...
def smv_rewrite_configs(app, config):
    ...
    if app.config.smv_current_version != '':
        ...
        app.config.html_logo = 'doc/_assets/images/' + distro + '-small.png'
