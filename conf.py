...
html_context = {
    ...
    'github_version': 'rolling',  # Will be overridden when building multiversion
...
smv_branch_whitelist = r'^(multiversion-test|multiversion-test-foxy)$'

smv_released_pattern = r'^refs/(heads|remotes/[^/]+)/(galactic|foxy).*$'
...
macros = {
    ...
    'REPOS_FILE_BRANCH': 'multiversion-test',
}
...
html_baseurl = 'https://docs.moveit.picknik.ai/en'
...
def smv_rewrite_configs(app, config):
    ...
    if app.config.smv_current_version != '':
        ...
        app.config.project = 'MoveIt Documentation: ' + app.config.smv_current_version.title()

        # app.config.html_logo = 'doc/Releases/' + app.config.smv_current_version + '-small.png'

        branch_distro = {
            'multiversion-test': 'rolling',
            'multiversion-test-foxy': 'foxy',
        }
