...
<<<<<<< HEAD
htmlproofer ./build --only-4xx --check-html --file-ignore ./build/genindex.html,./build/search.html --alt-ignore '/.*/' --url-ignore '#' --url-swap 'https\://github.com/ros-planning/moveit2_tutorials/blob/foxy/:file\://$PWD/build/' --url-swap 'https\://moveit.picknik.ai/foxy:file\://$PWD/build/'
=======
...
>>>>>>> 3215bec (Disable 429 errors (#225))
