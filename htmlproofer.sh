...
[[ -v GITHUB_HEAD_REF ]] || URL_SWAP="--url-swap https\://github.com/ros-planning/moveit2_tutorials/blob/main/:file\://$PWD/build/ --url-swap https\://moveit.picknik.ai/rolling:file\://$PWD/build/"
