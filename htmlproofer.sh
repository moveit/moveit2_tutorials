...
[[ -v GITHUB_HEAD_REF ]] || URL_SWAP="--url-swap https\://github.com/ros-planning/moveit2_tutorials/blob/foxy/:file\://$PWD/build/ --url-swap https\://moveit.picknik.ai/foxy:file\://$PWD/build/"
